...
console.log("You will need " + parseFloat(rectVolume).toFixed(2) + " cubic feet of soil.\nOr " + parseFloat(yardsOfSoil).toFixed(2) + " cubic yards of soil.\nThat is " + Math.round(bagsNeeded) + " bags of soil at 1.5 cubic feet per bag.\nThe weight of this soil would be approximately " + parseFloat(soilWeight).toFixed(2) + " pounds. \nThis would be great exercise for you. If you took one bag it would take you " + Math.round(carTrips1) + " trips to and from the car. \nIf you are an animal it would only take you " + Math.round(carTrips2) + " trips to and from the car.\nThank you for choosing Dave's Calculator, if you would like to submit different dimensions just refresh this page.");//I am trying to display the results on different lines instead of in a sentence so it will be easier to follow.
//The console.log statement will display in a easy flow manner so that the user can locate their needed information quickly and effortlessly.